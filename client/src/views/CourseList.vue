<template>
  <div class="course-list-container">
    <el-card class="course-list-card">
      ...
      <div v-else-if="filteredCourses.length === 0" class="empty-placeholder">
        暂无课程数据
      </div>
...
export default {
  ...
  setup() {
    ...
    const filteredCourses = computed(() => {
      ...
      // 分页
      return courses.slice((currentPage.value - 1) * pageSize.value, currentPage.value * pageSize.value);
    });
